...
class _TorrenttabState extends State<Torrenttab> with AutomaticKeepAliveClientMixin<Torrenttab>{
...
Widget noContentFound(){
  return Center(
    child: Column(
      ...
      children: <Widget>[
        Icon(Icons.not_interested,size: 50.0,),
